import { CreateProjectInput, Project, UpdateProjectInput } from '../application/project.types'
...
export interface ProjectServicePort {
  ...
  delete(activeOrganizationId: string, projectId: string): Promise<{ success: boolean }>
}
